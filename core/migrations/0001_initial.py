# Generated by Django 4.0.6 on 2022-08-11 22:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('M', 'Men'), ('W', 'Women'), ('UX', 'Unisex')], max_length=2)),
                ('brand_name', models.CharField(blank=True, choices=[('M', 'Men'), ('W', 'Women'), ('UX', 'Unisex')], max_length=2)),
                ('stock', models.CharField(blank=True, default='In Stock', max_length=50)),
